var beemovie_array = [
    ...
    "You are in a coma. This is our only way to communicate. Please wake up.",
];

function randomLine() {
    window.beetext.innerHTML = '"' + beemovie_array[Math.floor(Math.random() * beemovie_array.length)] + '"';
}
